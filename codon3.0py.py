...
seq_a='ACGAACGAAAATGGT'
seq_b='ACTCCACTGCCCGGA'
...
for stuff in seq_a_codon:
    if len(stuff) != 3:
        print('***Exit the program and throw your computer at the wall because of the disappointment you\'ve brought to your parents: Error A***')
        quit()
for stuff in seq_b_codon:
    if len(stuff) != 3:
        print('***Exit the program and throw your computer at the wall because of the disappointment you\'ve brought to your parents: Error B***')
        quit()
...
#this part will count the changes
TtoC=0
CtoT=0
GtoA=0
AtoG=0
